function onInit() {
    let container = document.getElementById('generator_results');
    container.innerHTML += getHeader(false);
    container.innerHTML += getDatenschutzContent();
    container.innerHTML += getFooter();

}

function getDatenschutzContent() {
    return `
        <div id='generator_results_content' class="datenschutz-container">
            <h1>Datenschutzhinweise</h1>
            <h2>Verantwortlicher</h2>
            <p>Verantwortlicher im Sinne der Datenschutzgesetze, insbesondere der EU-Datenschutz-Grundverordnung
                (DSGVO), ist:</p>
            <p class='generator_user_input'>Enrico Hoffmann</p>
